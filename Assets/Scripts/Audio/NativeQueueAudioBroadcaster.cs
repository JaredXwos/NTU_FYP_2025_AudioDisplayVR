...
/// </summary>
public sealed class NativeQueueAudioBroadcaster : MonoBehaviour
{
    private IHasNativeQueue<float> Provider;
    private SoundLogger log;

    private void Awake()
    {
        Check.PropertyEnabledElseAssign<IHasNativeQueue<float>>(this, "Provider");
        Check.PropertyEnabledElseAssign<SoundLogger>(this, "log");
    }
